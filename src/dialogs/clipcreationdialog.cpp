...
// static
void ClipCreationDialog::createColorClip(KdenliveDoc *doc, const QString &parentFolder, std::shared_ptr<ProjectItemModel> model, const std::function<void(const QString &)> &readyCallBack, int suggestedDuration)
{
...
void ClipCreationDialog::createAnimationClip(KdenliveDoc *doc, const QString &parentId, const std::function<void(const QString &)> &readyCallBack, int suggestedDuration)
{
...
const QString ClipCreationDialog::createPlaylistClip(const QString &name, std::pair<int, int> tracks, const QString &parentFolder,
                                                     std::shared_ptr<ProjectItemModel> model, const std::function<void(const QString &)> &readyCallBack, int suggestedDuration)
{
    return ClipCreator::createPlaylistClip(name, tracks, parentFolder, model, readyCallBack);
}

void ClipCreationDialog::createQTextClip(const QString &parentId, Bin *bin, ProjectClip *clip, const std::function<void(const QString &)> &readyCallBack, int suggestedDuration)
{
    ...
    if (clip) {
        ...
        int defaultDuration = pCore->currentDoc()->getFramePos(pCore->currentDoc()->timecode().getTimecode(GenTime(5, pCore->currentDoc()->timecode().fps()))); // Default 5s
        int duration = suggestedDuration > 0 ? qMin(suggestedDuration, defaultDuration) : defaultDuration;
...
// static
void ClipCreationDialog::createSlideshowClip(KdenliveDoc *doc, const QString &parentId, std::shared_ptr<ProjectItemModel> model, const std::function<void(const QString &)> &readyCallBack, int suggestedDuration)
{
...
void ClipCreationDialog::createTitleClip(KdenliveDoc *doc, const QString &parentFolder, const QString &templatePath, std::shared_ptr<ProjectItemModel> model, const std::function<void(const QString &)> &readyCallBack, int suggestedDuration)
{
...
void ClipCreationDialog::createTitleTemplateClip(KdenliveDoc *doc, const QString &parentFolder, std::shared_ptr<ProjectItemModel> model, const std::function<void(const QString &)> &readyCallBack, int suggestedDuration)
{
    ...
    if (dia->exec() == QDialog::Accepted) {
        ...
        ClipCreator::createTitleTemplate(dia->selectedTemplate(), dia->selectedText(), templateClipName, parentFolder, std::move(model), readyCallBack, suggestedDuration);
    }
}
...
void ClipCreationDialog::createClipsCommand(KdenliveDoc *doc, const QString &parentFolder, const std::shared_ptr<ProjectItemModel> &model, const std::function<void(const QString &)> &readyCallBack, int suggestedDuration)
{
